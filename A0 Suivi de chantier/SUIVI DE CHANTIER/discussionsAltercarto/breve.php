...
$op_file3 = fopen($fichier3,"w+");
if(strpos($fichier3, "istediscussion")>0){fwrite($op_file3,$haut);}else{fwrite($op_file3,$haut2);}
...
echo "<script language=\"javascript\">setTimeout('parent.location.href=\"../../MENUchantier.html\"',250)</script>";
?>