...
document.getElementById("p"+i).innerHTML="<iframe src='"+rep+"discussionsAltercarto/"+liste[i-1]+".html' width="+a+"  height="+(b-22)+" frameborder=0></iframe>"
}
}
...
tabViewObj.setTabTitles(liste2);
