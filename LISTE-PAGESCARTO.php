...
window.frames.zip_and_download.location.href="test_exist_zipdePageCartoDossier.php?NOM="+a+"" ;		
}
...
//liencarte+='</li><li>'
liencarte+='<a href="'+chem+mapX[k]+'/PageCartoDossier/version-pour-fouiller.html" target="_blank">Pour fouiller</a>'
//liencarte+='</li><li>'
...
liencarte+='</li><li>'
liencarte+='<a href="'+chem+mapX[k]+'/PageCartoDossier/indexVoirCarte.html" target="_blank">Page Voir Carte</a>'




liencarte+='<br><br><span id="testtel" onclick="window.open(\''+mapX[k]+'/PageCartoDossier-'+mapX[k]+'.zip\')" style="display:none;cursor:pointer; color:blue">Télécharger PageCartoDossier-'+mapX[k]+'.zip </span><span id="endate"></span>';



liencarte+='<br><br><span onclick="zip_and_telecharge(\''+mapX[k]+'/PageCartoDossier/\',\'PageCartoDossier-'+mapX[k]+'.zip\',\''+mapX[k]+'/\')" style="cursor:pointer; color:blue"><big>(re)-Zipper et Télécharger PageCartoDossier-'+mapX[k]+'.zip</big></span>';
