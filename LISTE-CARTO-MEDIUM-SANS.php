...
window.frames.zip_and_download.location.href="test_exist_zipdePageCartoDossierSANS.php?NOM="+a+"" ;		
}

function appelcarte(k,l){
	chem=window.location.href.replace("LISTE-CARTO-MEDIUM-SANS.php","")
liencarte2=""
...
liencarte+='<br><br><span id="testtel" onclick="window.open(\''+mapX[k]+'/PageCartoDossier-SANS-'+mapX[k]+'.zip\')" style="display:none;cursor:pointer; color:blue">Télécharger PageCartoDossier-SANS-'+mapX[k]+'.zip </span><span id="endate"></span>';
...
chem=window.location.href.replace('LISTE-CARTO-MEDIUM-SANS.php','');//chem.split("sc1/")[1]


chem=chem+mapX[k]+"/PageCartoDossier-SANS/Normal_SANS.html"
...
if(testCollab==1){
liencarte+='</li><li>'
liencarte+='<a href="'+mapX[k]+'/PageCartoDossier-SANS/version-pour-fouiller-COLLAB.html" target="_blank">Pour fouiller en Collaboratif</a>'
