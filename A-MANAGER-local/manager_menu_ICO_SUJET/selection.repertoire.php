...
//setTimeout("window.location.href='selection.repertoire.php'",100)
choixmenujs(Xrep)
document.getElementById("divfichiersjs").innerHTML=""
}
		</script>

	</div>
	<div style="position:fixed;top:5px;left:5px"><input type="button" value="fermer"  onclick="top.selectOnglet('east',2);ferme()"></input></div>
