...
echo '<script id="jscible" language="javascript" src="../../'.$REP.'/'.$cible.'?updated='.$alea.'"></script>';
/*
echo '<script id="jscible" language="javascript" ></script>';
echo '<script  language="javascript" >document.getElementById("jscible").src="../../'.$REP.'/'.$cible.'"</script>';
*/
...
document.getElementById("lblig").innerHTML="5 - libellés des lignes"						
document.getElementById("input11").setAttribute("style","visible;background-color:white")					
						...
						//alert('xtl= '+xtl)
document.getElementById("lblig").innerHTML="5 - libellés des lignes"	
document.getElementById("lblong").innerHTML="12 - libellé long"							
if(xtl[0]==1 & xtl[1]==3){//radar
document.getElementById("lblig").innerHTML="5 - données de comparaison"
			var xtl11=new Array()
...
document.getElementById("lblig").innerHTML="5 - noms des courbes"
			var xtl11=new Array()
			if( typeof(textarecup[i])=="string"){xtl11=textarecup[11].split(',')}else{xtl11=textarecup[11]}
...
window.frames.framedata.document.getElementById("ici").innerHTML=menudata
				...
				window.frames.framedata.document.getElementsByTagName("select")[w].selectedIndex=(xtlici[w]-2)
				
				var titleici=window.frames.framedata.document.getElementById(w+"_"+(xtlici[w])).firstChild.data
...
<!--div id="divfiledata" style="position:fixed;top:100px;left:40px;visibility:hidden;z-index:5">
<iframe id="framedata" name="framedata" style="background-color: #F9FAFD;opacity:1"  src="vide.htm" width="510" height="370" ></iframe></div-->
<div id="divfiledata" style="position:fixed;top:100px;left:40px;visibility:hidden;z-index:5">
<iframe id="framedata" name="framedata" style="background-color: #F9FAFD;opacity:1"  src="vide.htm" width="310" height="350" ></iframe></div>
...
<br><br><input type="text" id="menutitre" value="" name="menutitre" size="10" style="text-align:center;" readonly></div>
<br>
...
<br>
<span id="lblig" >5- libellé des lignes</span><br>
...
<td>(0,x)<br><input title="Simple or double curve" onclick="PRC(this)" type="radio" id="ParamCourb1"  name="bcou"  value="0,2"></td>
...
<td>(3,0)<br><input  name="brad"  title="To compare with a series of data manually included in menu[5] like 500,2500,4100,8000 - Result and référence data are presented as source value" onclick="PRC3(this)" type="radio" id="ParamRad6" value="3,0"></td>

<td>(3,1)<br><input  name="brad"  title="To compare with a series of data manually included in menu[5] like 500,2500,4100,8000 - The reference data are standardized and result is presented in percentage of standardized reference data" onclick="PRC3(this)" type="radio" id="ParamRad7" value="3,1"></td>
...
<textarea id="input12" name="input12" rows="3" cols="30"  onclick="if(document.getElementById('Q_3').checked==true & document.getElementById('input11').value[0]==2){ouvtableau(zencours,'input12')}"></textarea>
<br>
...
<script>
document.write('<div style="visibility:hidden"><iframe id="filedata" name="filedata"  src="../../'+mappocoord[6]+'/'+mappocoord[0]+'?alea='+Math.random()+'"></iframe></div>')
</script>
</center>
</body>
