...
document.getElementById("maj").setAttribute("action","'.$pdd.'A-MANAGER-local/CopyMapFolder/lister3/transcarte.php?platef='.$plateforme_distante.'&pdd='.$pdd.'&chgt='.$chgt.'&repcible='.$REPcible.'&reporigine='.$REPorigine.'");
