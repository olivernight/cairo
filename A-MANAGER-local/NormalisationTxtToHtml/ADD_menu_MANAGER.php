...
//$op_file=fopen($fichier2, "r");
//$contenu = fread($op_file, filesize($fichier2));
...
//echo $q[0];// contenu du fichier
//echo "<br><b>Menu ajouté dans ".$REP."/".$cible."  <br></b>";
//echo "<br><b>Données intégrées au fichier ".$REPDESTIN."/".$cibledestin."</b>";
echo '<script language="javascript">setTimeout("top.frames.editMenu.location.href=\'Oknormalise.php?fich='.$REPDESTIN.'/'.$cibledestin.'\'",2000)</script>';
?>
</body></html>