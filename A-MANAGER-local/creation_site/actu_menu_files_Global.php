...
echo"<script type='text/javascript'>document.getElementById('menuici').src='../../menuencapsulesILIADE.js'</script>";
echo"<script type='text/javascript'>setTimeout(\"top.indica0R();top.menucom(menuencaps,listpubcartovision)\",1700)</script>";
