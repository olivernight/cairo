...
echo '<br><br><center><dt><big><b>Permissions accès aux dossiers cartes</b></big></dt></center><br>';
...
for ( $i = 0; $i < count( $contents ); $i++ ) {
				...
				if ( $fileinfo[0] == "file" ) {} else {
					...
					echo '<dt><a href="mtdepas-permissionscartes-sites .htm?REP='.$fileinfo[1].'&SIT=" target="_self">'.$fileinfo[1].'</a></dt>';
					}
					/*
					if ( $fileinfo[1] == $REP[0] ){
			...
			echo '<br><dt>------------------------------</dt>';
//echo '<dt><a href="mtdepas-actusite.htm?REP=&SIT=SITE PILOTE" target="_self">SITE PILOTE</a></dt><br>';
//	echo '<dt>------------------------------</dt>';
//echo '<dt><a href="mtdepas-actusite.htm?REP=&SIT=Global" target="_self">Global</a></dt></center>';
