...
$hautverticCOLLAB='<?xml version="1.0"?>
...
<script language="javascript" src="azimut.js"><![CDATA[ // données 
]]></script>
<script id="section1" type="text/javascript" src="section1-COLLAB.js" ><![CDATA[
]]></script>
<script  type="text/javascript" src="zoomW3C-vertic.js" ><![CDATA[
]]></script>


<script language="javascript" src="principal.js"><![CDATA[ // données 
]]></script>
<script language="javascript" ><![CDATA[ 
...
<script language="javascript" src="DATA-IcoSujet.js"><![CDATA[ //  menu icones
]]></script>
<script language="javascript" src="DATA-Sujet.js"><![CDATA[ // menus graphiques
]]></script>
<script language="javascript" ><![CDATA[ 
...
<script language="javascript" src="DATA-IcoOther.js"><![CDATA[ //  menu icones
]]></script>
<script language="javascript" src="DATA-Other.js"><![CDATA[ // menus graphiques
]]></script>
...
<script language="javascript" src="listeAdditifContoursSVG.js"><![CDATA[ // données 
]]></script>
<script language="javascript" src="section2-COLLAB.js"><![CDATA[ // données 
]]></script>
<style type="text/css">
...
<b>Légende des graphiques ponctuels</b>
</td>
</tr>
...
<div id="PClogo2" style="display:none;position:absolute;top:8px;left:390px;;background-color:#E4E4E4"  onclick="open(\'http://altko.org/PageCartoGM/PageCarto/IndexPageCarto.html\')"><table width="130px"  ><tr height="55px"><td></td></tr></table></div>
<div id="PClogo1" style="position:absolute;top:8px;left:442px;;background-color:transparent" >

<svg id="bouton2"  style="display:none"
...
<a href=\'#\' onclick=\'ouvraide()\'  ><b>   Lisez moi      </b></a>&nbsp;&nbsp;
<a href="javascript:effaceIcone()">Efface les ronds</a>&nbsp;&nbsp;<a id="effFond" href="javascript:fondefface()">Efface les couleurs de fond</a>
...
<circle title="Zoom PLUS"  r="10" cy="11" cx="12" stroke-opacity="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1px" stroke="gray" fill-rule="evenodd" fill-opacity="0.80" fill="#3D93C7" id="b1" onclick="zoom(1.2);zoom(1)" ><title>Zoom PLUS</title></circle>
<g id="PlusSign" title="Zoom PLUS" transform="matrix(0.18, 0, 0, 0.18, 3, 1.7)" >
<path id="plusS" fill="white" d="M 60,40 L 90,40 L 90,60 L 60,60 L 60,90 L 40,90 L 40,60 L 10,60 L 10,40 L 40,40 L 40,10 L 60,10 L 60,40 L 60,40 z "  onclick="zoom(1.2);zoom(1)" /><title>Zoom PLUS</title>
</g>
<!-- ZOOM MOINS  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<circle title="Zoom MOINS"  r="10" cy="11" cx="37" stroke-opacity="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1px" stroke="gray" fill-rule="evenodd" fill-opacity="0.80" fill="#3D93C7" id="b2" onclick="zoom(0.833333);zoom(1)" ><title>Zoom MOINS</title></circle>
<g id="MinusSign" title="Zoom MOINS" transform="matrix(0.17, 0, 0, 0.25, 28.5, -29.2)">
<path id=" MoinsS" fill="white" d="M 10,150 L 90,150 L 90,170 L 10,170 L 10,150 z "  onclick="zoom(0.833333);zoom(1)" /><title>Zoom MOINS</title>
</g>	
...
<circle title="Zoom Zéro"  r="10" cy="11" cx="62" stroke-opacity="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1px" stroke="gray" fill-rule="evenodd" fill-opacity="0.80" fill="#3D93C7" id="b1" onclick="zoomZ()" ><title>Zoom Zéro</title></circle>
<circle title="Zoom Zéro"  r="7" cy="11" cx="62" stroke-opacity="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1px" stroke="gray" fill-rule="evenodd" fill-opacity="0.80" fill="white" id="b1" onclick="zoomZ()" ><title>Zoom Zéro</title></circle>	
<circle title="Zoom Zéro"  r="3" cy="11" cx="62" stroke-opacity="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1px" stroke="gray" fill-rule="evenodd" fill-opacity="0.80" fill="#3D93C7" id="b1" onclick="zoomZ()" ><title>Zoom Zéro</title></circle>		
...
<circle  r="10" cy="11" cx="12" stroke-opacity="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1px" stroke="gray" fill-rule="evenodd" fill-opacity="0.80" fill="#3D93C7" id="b1" onclick="tailleicoplus()" ><title>agrandir les graphiques ponctuels</title></circle>
<g id="PlusSign" title="agrandir les graphiques ponctuels" transform="matrix(0.18, 0, 0, 0.18, 3, 1.7)" >
<path id="plusS" fill="yellow" d="M 60,40 L 90,40 L 90,60 L 60,60 L 60,90 L 40,90 L 40,60 L 10,60 L 10,40 L 40,40 L 40,10 L 60,10 L 60,40 L 60,40 z "  onclick="tailleicoplus()" title=""  /><title>agrandir les graphiques ponctuels</title>
</g>
...
<circle title="réduire les graphiques ponctuels"  r="10" cy="11" cx="39" stroke-opacity="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1px" stroke="gray" fill-rule="evenodd" fill-opacity="0.80" fill="#3D93C7" id="b2" onclick="tailleicomoins()" ><title>réduire les graphiques ponctuels</title></circle>
<g id="MinusSign" title="réduire les graphiques ponctuels" transform="matrix(0.17, 0, 0, 0.25, 30.5, -29.2)">
<path id=" MoinsS" fill="yellow" d="M 10,150 L 90,150 L 90,170 L 10,170 L 10,150 z "  onclick="tailleicomoins()" /><title>réduire les graphiques ponctuels</title>
</g>
...
<script type="text/javascript" src="section3.js"><![CDATA[
...
<div id="divbalise" style="position:absolute;top:330px;left:538px;display:none;z-index:6000"><table style="background-color:rgb(228, 228, 228);border:0px solid black">

<tr><td  id="balises0x" style="width:160px;border:0px solid black" ><textarea id="boiteHtmlx" style="height:23px;width:160px;font-size:11px;border:1px dotted gray" ></textarea></td><td style="font-size:10px">HTML<br/><input style="height:15px;font-size:8px;cursor:pointer" type="button" value=" go " onclick="testBaliseBoite(0);"></input></td><td  id="balises0" style="width:200px;border:1px solid black;display:none" >&nbsp;-&nbsp;<span id="boitebalise"  >Code HTML en cours</span>&nbsp;</td><!--/tr>

<tr--><td  id="balises1x" style="width:160px;border:0px solid black" ><textarea id="boitebalisex" style="height:23px;width:160px;font-size:11px;border:1px dotted gray" ></textarea></td><td  style="font-size:10px">Balises<br/><input style="height:15px;font-size:8px;cursor:pointer" type="button" value=" go " onclick="testBaliseBoite(1);"></input></td><td  id="balises1" style="width:200px;border:1px solid black;display:none" >&nbsp;-&nbsp;<span id="boitebalise"  >balise en cours</span>&nbsp;</td></tr>

<tr><td  id="balises2x" style="width:160px;border:0px solid black" ><textarea id="balisegraphx"  style="height:23px;width:160px;font-size:11px;border:1px dotted gray" ></textarea></td><td style="font-size:10px">graph<br/><input style="height:15px;font-size:8px;cursor:pointer" type="button" value=" go "  onclick="testBaliseBoite(2);"></input></td><td id="balises2"  style=";border:1px solid black;display:none">&nbsp;-&nbsp;<a href="" id="balisegraph">graph</a>&nbsp;</td><!--/tr>

<tr--><td id="balises3"  style=";border:0px solid black;"> <table style="background-color:white;height:25px;width:160px;border:1px dotted gray"><tr><td>  &nbsp;-&nbsp;<a id="boiteAirebalise" style="color: blue; font-size: 10px;" onclick="" href="javascript:rien()">nom de l\'aire</a>&nbsp;    </td></tr></table> </td><td style="font-size:10px">aire<br/><input style="height:15px;font-size:8px;cursor:pointer" type="button" value=" go "  onclick="testBaliseBoite(3);"></input></td><td>&nbsp;-&nbsp;</td></tr></table>

</div>

<div id="divtexte" style="position:absolute;top:90px;left:970px;z-index:4000">
<iframe id="hypertexte" name="hypertexte" src="../InterfaceDiscussion.html?discut=hypertexte" scrolling="no" width="640" height="500" frameborder="no" />
...
<table style="display:none" id="tabFiche" width="160" onmousedown="document.getElementById(\'hut\').innerHTML=xtx;" onmouseup="document.getElementById(\'hut\').innerHTML=\' \n  \n  \';" border="1"><tr><td style="color:transparent"> <br/>    <br/>  <br/>  <br/> </td></tr><tr ><td id="hut" style="color:transparent"></td></tr><tr><td></td></tr></table>
</div>
...
<script type="text/javascript" src="section4-COLLAB.js">
