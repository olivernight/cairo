...
var largeurHistoGRAND=275//350
var Histomulti=0
var largeurHisto=275//200
var GrandHisto=0
var HISTOLA=''
...
//alert(GrandHisto)
HISTOLA=''
document.getElementById("commandeTialleHisto")="Agrandir le graphique"
...
if(clickOuHyper==0){GrandHisto=1}//0}
recupDim()//RADAR
...
HISTOLA=histola
// RADAR
if(menuSujet[iSujet][3][0]==1 & menuSujet[iSujet][3][1]==3){HISTOLA='<div style="position: absolute;top:-20px;left:5px"><div style="position:relative;left:-5px"><table style="background-color:white;border : solid black 0px;-moz-border-radius: 5px 5px 0px 0px;-moz-border-top-right-radius: 5px;"><tr style="display:none"><td><a style="opacity:0.5" id="commandeTialleHisto" href="javascript:EtatHisto()">'+agred+'</a></td></tr></table></div></div><iframe id="zam2" name="zam2" width="200px" height="200px" scrolling="no" frameborder="0" src="GRAPH-RADAR/radar.xml" ></iframe>';histola=HISTOLA
...
if(menuSujet[iSujet][3][0]==3 & menuSujet[iSujet][3][1]==1){;HISTOLA='<div style="position: absolute;top:-20px;left:5px"><div style="position:relative;left:-5px"><table style="background-color:white;border : solid black 0px;-moz-border-radius: 5px 5px 0px 0px;-moz-border-top-right-radius: 5px;"><tr style="display:none"><td><a style="opacity:0.5" id="commandeTialleHisto" href="javascript:EtatHisto()">'+agred+'</a></td></tr></table></div></div><iframe id="zam2" name="zam2" width="200px" height="200px" scrolling="no" frameborder="0" src="GRAPH-COURBE/courbe.xml" ></iframe>';histola=HISTOLA
LaCourbe=1
