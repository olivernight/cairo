...
window.frames.framedata.document.getElementById("ici").innerHTML=menudata
				...
				if(window.frames.framedata.document.getElementById(w+"_"+(xtlici[w]))){
...
<script>
document.write('<div style="visibility:hidden"><iframe id="filedata" name="filedata"  src="PrincComp.htm?cible=../../'+urlvar["REP"]+'/PageCartoDossier/PageCarto/principal.js?updated=1234567890"></iframe></div>')
</script>
</center>
</body>
