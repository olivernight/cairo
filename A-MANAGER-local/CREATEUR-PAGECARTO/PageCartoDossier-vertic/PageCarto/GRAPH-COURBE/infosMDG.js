...
zf+=1;FicheMDG(zf,"gray","--------------------",gras,"")
zf+=1;FicheMDG(zf,coul[2],leg3,gras,"Design with curve of estimation (See methodology)")
zf+=1;FicheMDG(zf,coul[2],valproject,gras,valproject)
/*
zf+=1;FicheMDG(zf,"gray","--------------------",gras,"")
...
document.getElementById("tbt3").setAttribute("title","Shows the estimate by the line connecting the first to the last measure")
document.getElementById("tbt4").setAttribute("title","Displays measures")
}else{
