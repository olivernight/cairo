...
var titregraph
if(NoDatx==0){titregraph=" "}else{titregraph=document.getElementById(NoDatx).getAttribute("title")}
...
if(GrandHisto==0){var largtitre=150;}else{var largtitre=220;}
var poltit="11"
if(titreX[1].length>55){poltit=9 ;titreX[1]=titreX[1].replace("<br/>","   ")}else{}
histola+='</tr><tr height="15px" align="left"><td></td><td style="font-size:'+poltit+'px;"><div  style="position:absolute"><div style="position:relative;top:-15px;width:'+largtitre+'px"><b>'+(iSujet+1)+' - '+titreX[1]+'</b></div></div></td></tr><tr><td style="width:10px"></td><td>'
