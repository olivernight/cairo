...
window.frames.filedata.location.href="PrincComp.htm?cible=../../"+urlvar["REP"]+"/PageCartoDossier/PageCarto/principal.js?updated=1234567890"//"../../"+urlvar["REP"]+"/principal.html"
Fencours=1
}
}
function chargeComplementaire(){
if(Fencours!=2){
window.frames.filedata.location.href="PrincComp.htm?cible=../../"+urlvar["REP"]+"/PageCartoDossier/PageCarto/complementaire.js?updated=1234567890"//"../../"+urlvar["REP"]+"/complementaire.html"
Fencours=2
}
}
</script>
...
document.write('<div style="visibility:hidden"><iframe id="filedata2" name="filedata2"  ></iframe></div>')
