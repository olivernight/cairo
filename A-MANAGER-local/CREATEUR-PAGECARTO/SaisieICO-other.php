...
function chargePrincipal(){
	if(parent.parent.window.location.href.indexOf("Hypertexte-BLANC")>0){
window.frames.filedata.location.href="PrincComp.htm?cible=../../"+urlvar["REP"]+"/PageCartoDossier-BLANC/PageCarto/principal.js?updated=1234567890"
	}else{
window.frames.filedata.location.href="PrincComp.htm?cible=../../"+urlvar["REP"]+"/PageCartoDossier/PageCarto/principal.js?updated=1234567890"		
	}
document.getElementById('input6').value="principal"
}
function chargeComplementaire(){
		if(parent.parent.window.location.href.indexOf("Hypertexte-BLANC")>0){
window.frames.filedata.location.href="PrincComp.htm?cible=../../"+urlvar["REP"]+"/PageCartoDossier-BLANC/PageCarto/complementaire.js?updated=1234567890"//
		}else{
window.frames.filedata.location.href="PrincComp.htm?cible=../../"+urlvar["REP"]+"/PageCartoDossier/PageCarto/complementaire.js?updated=1234567890"//			
...
<script>
	if(parent.parent.window.location.href.indexOf("Hypertexte-BLANC")>0){
document.write('<div style="visibility:hidden"><iframe id="filedata" name="filedata"  src="PrincComp.htm?cible=../../'+urlvar["REP"]+'/PageCartoDossier-BLANC/PageCarto/complementaire.js?updated=1234567890"></iframe></div>')
document.write('<div style="visibility:hidden"><iframe id="filedata2" name="filedata2" src="PrincComp.htm?cible=../../'+urlvar["REP"]+'/PageCartoDossier-BLANC/PageCarto/principal.js?updated=1234567890" ></iframe></div>')
	}else{
document.write('<div style="visibility:hidden"><iframe id="filedata" name="filedata"  src="PrincComp.htm?cible=../../'+urlvar["REP"]+'/PageCartoDossier/PageCarto/complementaire.js?updated=1234567890"></iframe></div>')
document.write('<div style="visibility:hidden"><iframe id="filedata2" name="filedata2" src="PrincComp.htm?cible=../../'+urlvar["REP"]+'/PageCartoDossier/PageCarto/principal.js?updated=1234567890" ></iframe></div>')		
		
	}
//window.frames.filedata2.location.href="PrincComp.htm?cible=../../"+urlvar["REP"]+"/PageCartoDossier/PageCarto/principal.js?updated=1234567890"
</script>
</body>
</center>
</html>