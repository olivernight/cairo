var essaiBLANC=1 // change le mode d'affichage (en bas de section4 et début de section1)
...
// position Histo
var leftHisto=Wsvg+30
var topHisto=CarteY+Hsvg+20+decalvertical-30
//alert(topHisto)
...
// DIV des légende
var topleg=CarteY+Hsvg+18+decalvertical-50
var leftleg=CarteX
...
document.getElementById("gene").setAttribute("width",Wsvg)
document.getElementById("gene").setAttribute("height",Hsvg)
//alert(" ligne 767 : topHisto = "+topHisto)
document.getElementById("innerhisto").style.top=(topHisto)+"px"
document.getElementById("innerhisto").style.left=(leftHisto-17)+"px"
...
intermed[0]=basex[i]
intermed[1]=nomzone[i]+" [ "+basex[0]+" : "+basex[i]+" ]"
/*
if(initaff==2 ){}else{
XXfond[i]=intermed
maxfond=max
...
document.getElementById("legicotablibel").innerHTML="<b><span >"+menuIconeEchelle[Icone][1]+"</span></b> "+icilog
document.getElementById("legicotablibel").title="n°"+(Icone+1)+" - "+menuIconeEchelle[Icone][1]+" (Source : "+menuIconeEchelle[Icone][2]+")"+icilog
}else{
...
document.getElementById("legfondtablibel").innerHTML="<b><span >"+menuIconeEchelle[Icone][1]+"</span></b>"
document.getElementById("legfondtablibel").title="n°"+(Icone+1)+" - "+menuIconeEchelle[Icone][1]+" (Source : "+menuIconeEchelle[Icone][2]+")"
if(etatico==0){
...
document.getElementById("legicotab").innerHTML=""
document.getElementById("legicotablibel").innerHTML=""
document.getElementById("legicotablibel").title=""
...
document.getElementById("legfondtablibel").title=legfondtablibeltemp
initaff=1
}//fond2()
}
...
document.getElementById("legfondtablibel").innerHTML=""
document.getElementById("legfondtablibel").title=""
