...
//echo '<script language="javascript">alert(" dir = '.$dir.'")</script>';	
...
//echo '<script language="javascript">alert(" file  dans '.$dir.'   =  '.$filename.'")</script>';
	...
	//				echo '<script language="javascript">alert(" REPERTOIRE  dans '.$dir.'   =  '.$filename.'")</script>';
						if ( strpos( $filename, "." ) !== 0 ) {
