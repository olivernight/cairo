...
var Wsvg=500*5/5// standard = 500
var Hsvg=435*5/5 // standard = 320
...
// DIV du menu icones
var MenuIcoX=Wsvg+30+210
var MenuIcoY=CarteY+Hsvg-45+decalvertical+203



// DIV du menu quantiles
var MenuQuantilesX=Wsvg+30+120+210
var MenuQuantilesY=CarteY+Hsvg-70+decalvertical+203

// DIV du menu palette
var MenuPaletteX=Wsvg+30+120+210
var MenuPaletteY=CarteY+Hsvg-95+decalvertical+203

//DIV boutons Radio
var MenuRadioX=Wsvg+30+210
var MenuRadioY=CarteY+Hsvg-95+decalvertical+203

// DIV recherche
var leftrechercheX=Wsvg+30+210
var toprechercheY=CarteY+Hsvg-135+decalvertical+203
...
// DIV du menu graphique
var MenuHistoX=Wsvg+30+210
var MenuHistoY=CarteY+Hsvg-20+decalvertical+203
...
var contenuBaliseEnCours="balise en cours"
var contenuGraphEnCours="graph en cours"
var contenuHtmlEnCours="Code HTML en cours"
var libelAIreTemp
function boitebalise(){}

function testBaliseBoite(a){
if(a==0){
if(document.getElementById('boiteHtmlx').value==""){ alert("saisissez les éléments de code HTML à insérer");
}else{contenuHtmlEnCours=document.getElementById('boiteHtmlx').value;boitebalise2(a)}
}
if(a==1){
if(document.getElementById('boitebalisex').value==""){ alert("saisissez un libellé pour la BALISE");
}else{contenuBaliseEnCours=document.getElementById('boitebalisex').value;boitebalise2(a)}
}
if(a==2){
if(document.getElementById('balisegraphx').value==""){ alert("saisissez un libellé pour le GRAPHIQUE");
}else{contenuGraphEnCours=document.getElementById('balisegraphx').value;boitebalise2(a)}
}
if(a==3){
if(libelAIre){
if(libelAIre==libelAIreTemp){}else
{
libelAIreTemp=libelAIre
boitebalise2(a)

}
}else{alert("sélectionnez une aire de la carte")}}
}
function boitebalise2(a){
...
var baliseici='%3Ca href="javascript:CPonctuel('+(n0)+','+palX+','+caticotemp0+','+zpm+','+PropNonProp+');Cfond('+(n1)+','+palY+','+catfondtemp0+');Cgraph('+(n3)+','+GrandHisto+')"%20%3E '+contenuBaliseEnCours+' %3C/a%3E' 
var graphici='%3Ca href="javascript:Cgraph('+(n3)+','+GrandHisto+')"%20%3E '+contenuGraphEnCours+' %3C/a%3E'
//var AireBal=document.getElementById("boiteAirebalise").getAttribute("onclick")
var AireBalici=AireBal
AireBalici='%20-%20%3Ca href="javascript:'+AireBalici+'"%20%3E%20%3Csmall%3E'+libelAIre+'%3C/small%3E%20%3C/a%3E'
...
var insaisie=window.frames.hypertexte.document.getElementById("message0").value
if(a==0){insaisie=insaisie+contenuHtmlEnCours.replace(/</g,"%3C").replace(/>/g,"%3E")}
if(a==1){insaisie=insaisie+"<br/>"+baliseici;document.getElementById('boitebalisex').value=""}
if(a==2){insaisie=insaisie+"<br/>%3Cu style='color:gray' %3EGraphique :%3C/u%3E <br/>"+graphici;document.getElementById('balisegraphx').value=""}
if(a==3){insaisie=insaisie+AireBalici}
window.frames.hypertexte.document.getElementById("message0").value=insaisie
...
AireBal='NoDatx='+a+';marqueurcarte();calculHisto(NoDatx,iSujet)'
...
var icilog=""
if(testla==1){icilog="<b><i style=\"color:red\">radius of circles=Log(Value) : </i></b>"}
document.getElementById("legicotablibel").innerHTML="n°"+(Icone+1)+" - "+icilog+"<b><span title=\""+menuIconeEchelle[Icone][12]+"\">"+menuIconeEchelle[Icone][1]+"</span></b> (Source : "+menuIconeEchelle[Icone][2]+")"
