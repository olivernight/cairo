...
//if(i< 25){alert(document.all["span"+i].outerHTML)}

var outh=document.all["span"+i].outerHTML
...
outh=outh.replace(/&#10;/g,'')
document.all["span"+i].outerHTML=outh
document.all["span"+i].style.setAttribute("cssText","color:blue;cursor:pointer;")
...
var NewBalise='<small><a href="javascript:CPonctuel('+(icoici-2000)+',chinois,2,'+ico[4]+');Cfond(0,chinois,0);Cgraph('+gr+')">'+ico[1]+'</a></small>'
...
var NewBalise='<small><a href="javascript:CPonctuel(0,chinois,0,0);Cfond('+(icoici-2000)+','+coulheur+','+Qt+');Cgraph('+gr+')"></small>'+ico[1]+'</a>'
...
var NewBalise='<small><a href="javascript:CPonctuel('+(icoici2-2000)+',chinois,2,'+ico[8]+');Cfond('+(icoici-2000)+','+coulheur+','+Qt+');Cgraph('+gr+')">fond : '+ico[1]+' - icone : '+ico[6]+'</a></small>'
...
var NewBalise='<small><a href="javascript:Cgraph('+gr+')">'+ico[1]+'</a></small>'
...
var NewBalise='<small><a href="javascript:CPonctuel('+(icoici-2000)+',chinois,2,'+ico[4]+');Cfond(0,0,0);Cgraph('+gr+')">'+ico[1]+'</a></small>'
...
parent.frames.changeaide.location.href="../../../A-MANAGER-local/CREATEUR-PAGECARTO/Onglet-PageCarto-Hypertexte/SaisieMAJ-CP/MENUAIDE/filesaide/ecrit_hypertext.html?LISTEJS="+repcarte
