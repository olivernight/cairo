...
var basemenucontxt=""
basemenucontxt+=('<div  onmouseoutxxx="javascript:indicouvici=0" id="menu_context" style="z-index:500;position:absolute;width:'+taillebg+'px; border:2px solid #9D9DA1; background-color:'+colorbg+'; font-family:Verdana; font-size:10px; cursor:default; visibility:hidden;padding:3" >');
...
}else{document.write(basemenucontxt)}
//alert(basemenucontxt)
//
if(document.all){
