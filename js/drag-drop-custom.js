...
DHTMLgoodies_common.prototype = {
	...
	{		
	  var returnValue = inputObj.offsetTop-TopICI;
	...
	{	  
	  var returnValue = inputObj.offsetLeft-LeftICI;
	  while((inputObj = inputObj.offsetParent) != null){
	  	if(inputObj.tagName!='HTML'){
...
DHTMLgoodies_dragDrop.prototype = {
	...
	__stop_dragDropElement : function(e)
	{
		...
		var leftPosMouse = e.clientX + Math.max(document.body.scrollLeft,document.documentElement.scrollLeft)-LeftICI;
		var topPosMouse = e.clientY + Math.max(document.body.scrollTop,document.documentElement.scrollTop)-TopICI;
