...
document.getElementById("p"+i).innerHTML="<iframe src='"+rep+"filesaide/"+liste[i-1]+".html?"+Math.random()+"' width="+a+"  height="+(b-22)+" frameborder=0></iframe>"
}
}

function forcepane(a){

document.getElementById("xmod").setAttribute("href",'MENUAIDE/MODIFaide.html?onglet=0&pane='+a)
parent.stockpane(a)
...
tabViewObj.setIndexActiveTab(paneactive);
...
document.getElementById("tabTabDHTMLSuite_tabView1_"+i).setAttribute("onmousedown","forcepane("+i+")")
